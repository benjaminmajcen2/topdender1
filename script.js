mapboxgl.accessToken = 'pk.eyJ1IjoiYmVuY2hzcG90dGVycyIsImEiOiJjbGJrdnAycXQwMW1rM25waXF1dHQ4djRhIn0.k00FDSeJrdDFoV_tMw7tLQ';
    const map = new mapboxgl.Map({
        ...
        center: [4.025284939552062, 52.9203042749],
        maxBounds: [[3.57986,50.69557],[4.30082,51.1037]],
        zoom: 9.5
    });
            ...
            'data': {
                ...
                'features': [
                    ...
                    },
                  {
                        ...
                        'geometry': {
                            'type': 'Point',
                            'coordinates': [3.86709758,50.76163277]
                        }
                    },
                  {
                        'type': 'Feature',
                    ...
                    },
                  {
                        ...
                        'geometry': {
                            'type': 'Point',
                            'coordinates': [3.923864267,50.755622473]
                        }
                    },
                  {
                        'type': 'Feature',
